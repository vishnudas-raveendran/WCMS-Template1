...
<div class="content-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="page-head-line">Achievements</h4>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#insert" data-toggle="tab">Add new achievement</a>
                                </li>
                                <li class=""><a href="#edit" data-toggle="tab">Edit achievement</a>
                                </li>
                                <li class=""><a href="#delete" data-toggle="tab">Delete achievement</a>
                                </li>
                            </ul>

                            <div class="tab-content">
                                <div class="tab-pane fade active in" id="insert">
                                    <h4>Add new achievement</h4></br>
									<div class="alert alert-info">
									Note: Please ensure that the image filenames are different while uploading to ensure images are not replaced.
									</div>
								</br>
								 <form enctype="multipart/form-data" action="../include/edit_achievements.php" method="post">
						...
						$sql="SELECT `id`,`title`,`caption`,`img_ref`,`link` FROM achievements";
						$stmt=$db->prepare($sql);
						$stmt->execute();
						?>
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
											...
											<td><img src="../../images/achievements/<?php echo $e['img_ref']?>.jpg" width="150" height="100"></td>
...
?>
								...
								</div>  <!-- edit achievements tab ends here -->
								
								<!--- edit achievements ends -->
								
								
								<!-- delete achievements contents -->
								<div class="tab-pane fade" id="delete">
                                    <h4>Delete achievements</h4></br>
									<div class="alert alert-info">
									Note: Please ensure that the image filenames are different while uploading to ensure images are not replaced.
									</div>
								</br>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
											<form action="../include/edit_achievements.php" method="POST">
