...
$sql="SELECT `title`,`caption`,`link`,`img_ref` FROM news";
$stmt=$db->prepare($sql);
$stmt->execute();
$data = $stmt -> fetchAll();
?>
...
<div class="about-section">
				<div class="container">
						...
						<h3 align="center" style="color:#747474"> News </h3></br></br>
								...
								<div class="container">
									...
									?>
										...
										<div class="col-md-3 featured-grid">
											...
											<img src="../images/news/<?php echo $e['img_ref'];?>.jpg" class="img-responsive zoom-img" alt="<?php echo $e['title'];?>"></a>
